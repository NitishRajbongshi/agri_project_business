...
>
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('admin_assets/img/favicon/agri.ico') }}"/>
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        @include('moderator.common.sidebar')
        <!-- / Menu -->
        ...
        <div class="layout-page">
          ...
          @include('moderator.common.navbar')
          ...
          <div class="content-wrapper">
            ...
            <!-- Footer -->
            @include('moderator.common.footer')
            <!-- / Footer -->
