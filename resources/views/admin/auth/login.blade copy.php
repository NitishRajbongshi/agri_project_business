            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="" class="app-brand-link gap-2">
                  ...
                  {{-- <span class="app-brand-text demo text-body fw-bolder">Crop Health <br> Diagnosis System</span> --}}
                  <span class="app-brand-text text-body fw-bolder h3 text-center">SmartAg System</span>
                </a>
              </div>
              <!-- /Logo -->
              {{-- <h4 class="mb-2">Welcome to Crop Health Diagnosis System!</h4> --}}
